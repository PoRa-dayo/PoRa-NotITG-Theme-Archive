...
-- These will be the option rows available on the [nth] option screen. The 'NextScreen' row will be automatically added as long as there is more than 1 option screen.
	playerOptions = {}
	playerOptions[1] = { 'SpeedType','SpeedNumber','Mini','Perspective','NoteSkin','JudgmentFont','HoldJudgment','Turn','LifeBar','Compare','Rate' }
...
ModsMaster.Turn =			{ modlist = {'Mirror','Left','Right','Shuffle','SmartBlender','Blender'}, default = 'no mirror,no left,no right,no shuffle,no supershuffle,nosmartblender', mods = {'mirror','left','right','shuffle','smartblender','supershuffle'} }
