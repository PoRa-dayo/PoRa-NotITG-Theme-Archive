...
ModsMaster.Turn =			{ modlist = {'Mirror','Left','Right','Shuffle','SmartBlender','Blender'}, default = 'no mirror,no left,no right,no shuffle,no supershuffle', mods = {'mirror','left','right','shuffle','supershuffle'} }
