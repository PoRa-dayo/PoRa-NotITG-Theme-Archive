...
local GraphicsLevels = {
	THEME:GetMetric('GraphicOptions', 'LowLevel'),
 	THEME:GetMetric('GraphicOptions', 'MedLevel'),
 	THEME:GetMetric('GraphicOptions', 'HigLevel'),
 	THEME:GetMetric('GraphicOptions', 'MaxLevel')
 }
