...
function LifebarAdjustmentRow()
	local Names = { "-100", "-70", "-50", "-25", "0", "10", "20", "30", "40", "50", "280" }

	local type = PROFILEMAN:GetMachineProfile():GetSaved().LifebarAdjustment
	
	local function Load(self, list, pn)
		if not type then list[5] = true return end
	...
	local Params = { Name = "Lifebar Adjustment" }
...
function CleanScreen()
	...
	local Params = { Name = "Clean Screen" }
...
function CleanStartTime()
	...
	local Params = { Name = "Clean Start Time" }
...
function CleanEndTime()
	...
	local Params = { Name = "Clean End Time" }
...
function MusicSelectTime()
	...
	local Params = { Name = "Music Select Time" }
...
function OptionsSelectTime()
	...
	local Params = { Name = "Options Select Time" }
...
function EvaluationScreenTime()
	...
	local Params = { Name = "Evaluation Screen Time" }
...
function GlobalOffset()
	...
	local Params = { Name = "Global Offset" }
...
function JudgePaddingToggleRow()
	...
	local Params = { Name = "Judge Padding" }
