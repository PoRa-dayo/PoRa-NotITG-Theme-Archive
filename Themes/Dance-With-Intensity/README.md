...
To change the profile name:
   ...
   local ProfileNames = {
	...
	-- The names won't update until you restart the game or F3+R
   ...
   You can just edit the names that are in there, so they will load with another name instead.
   Here is an example of a Profile Setup completed.
